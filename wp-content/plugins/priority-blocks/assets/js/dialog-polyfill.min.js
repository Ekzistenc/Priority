! ( function ( e, t ) {
	...
	function l( e ) {
		...
		return (
			o ||
				( o = (
					( 'getRootNode' in ( e = e.target ) && e.getRootNode() ) ||
					document
				).activeElement ),
			o && o.form === t ? o : null
		);
	...
	function s( e ) {
		...
		e.defaultPrevented ||
			...
			( n = a( t ) ) &&
				...
				( e.preventDefault(), null != o ? n.close( o ) : n.close() ) );
	}
	function t( o ) {
		var i, n, a, t;
		( this.dialog_ = o ),
			...
			( this.openAsModal_ = ! 1 ),
			o.hasAttribute( 'role' ) || o.setAttribute( 'role', 'dialog' ),
			( o.show = this.show.bind( this ) ),
			( o.showModal = this.showModal.bind( this ) ),
			( o.close = this.close.bind( this ) ),
			o.addEventListener( 'submit', s, ! 1 ),
			'returnValue' in o || ( o.returnValue = '' ),
			'MutationObserver' in window
				? new MutationObserver(
						this.maybeHideModal.bind( this )
				  ).observe( o, {
						attributes: ! 0,
	...
	( i && 'object' != typeof i ) ||
		...
		( t.prototype = {
			...
			maybeHideModal: function () {
				( this.dialog_.hasAttribute( 'open' ) && e( this.dialog_ ) ) ||
					this.downgradeModal();
			},
			...
			backdropMouseEvent_: function ( e ) {
				this.dialog_.hasAttribute( 'tabindex' )
					? this.dialog_.focus()
			...
			focus_: function () {
				var e = this.dialog_.querySelector(
					'[autofocus]:not([disabled])'
				);
				! e && 0 <= this.dialog_.tabIndex && ( e = this.dialog_ ),
					( e =
						e ||
						( function e( t ) {
							var o = [
				...
				! ( function ( e ) {
					for ( ; e && e !== document.body;  ) {
						...
						if (
							...
							'isolate' === o.isolation ||
							'fixed' === o.position ||
							'touch' === o.webkitOverflowScrolling
						)
							return 1;
						e = e.parentElement;
					}
					...
					this.setOpen( ! 0 ),
					( this.openAsModal_ = ! 0 ),
					p.needsCentering( this.dialog_ )
						? ( p.reposition( this.dialog_ ),
	...
	return (
		( p.isInlinePositionSetByStylesheet = function ( e ) {
		...
		( p.needsCentering = function ( e ) {
			return (
				...
				! p.isInlinePositionSetByStylesheet( e )
			);
		} ),
		...
		( p.DialogManager.prototype.containedByTopDialog_ = function ( e ) {
			for ( ; ( e = a( e ) );  ) {
				for ( var t, o = 0; ( t = this.pendingDialogStack[ o ] ); ++o )
					if ( t.dialog === e ) return 0 === o;
				e = e.parentElement;
			}
			return ! 1;
		} ),
		( p.DialogManager.prototype.handleFocus_ = function ( e ) {
			...
			if (
				...
				return (
					e.dialog.compareDocumentPosition( t ) &
		...
		( p.DialogManager.prototype.pushDialog = function ( e ) {
			...
			return (
				...
				( 1 === this.pendingDialogStack.unshift( e ) &&
					this.blockDocument(),
				this.updateStacking(),
				! 0 )
			);
		...
		( p.dm = new p.DialogManager() ),
		( p.formSubmitter = null ),
		( p.imagemapUseValue = null ),
		void 0 === window.HTMLDialogElement &&
			( ( d = document.createElement( 'form' ) ).setAttribute(
				'method',
				'dialog'
			),
			'dialog' === d.method ||
