! ( function ( e, t ) {
							...
							if ( ( ( this.isDoubleTap = ! 1 ), i > 1 ) ) {
								...
								null !== t.x &&
									...
									null !== this.x2 && null !== this.sx2
										? ( ( e.deltaX =
												( n - this.x2 + l - this.sx2 ) /
												2 ),
										  ( e.deltaY =
												( s - this.y2 + o - this.sy2 ) /
												2 ) )
										: ( ( e.deltaX = 0 ),
										  ( e.deltaY = 0 ) ),
	...
	function G( e, t, i, n ) {
		...
		if (
			...
			( C( d ) &&
				( s = m(
					'<div class="ginlined-content">'.concat( d, '</div>' )
				) ),
			k( d ) )
		) {
						...
						value: function () {
							...
							this.slidePlayerPause( e ),
								...
								this.prevActiveSlideIndex > this.index &&
									'slide' == this.settings.slideEffect &&
									( i =
										this.settings.cssEfects.slideBack.out ),
								g( e, i, function () {
									var t =
											e.querySelector(
												'.ginner-container'
					...
					},
					{
						...
						value: function () {
							...
							( this.prevButton = d.querySelector( '.gprev' ) ),
								( this.nextButton =
									d.querySelector( '.gnext' ) ),
								( this.overlay =
									d.querySelector( '.goverlay' ) ),
