/******/ (() => { // webpackBootstrap
/*!*********************************!*\
  !*** ./src/compromises/view.js ***!
  \*********************************/
document.addEventListener('DOMContentLoaded', () => {
  (function () {
    document.querySelectorAll('.sd-compromises__slider').forEach((swiperItem, index) => {
      ...
      addIndexClass(swiperItem, index, 'swiper-pagination-compromises');
      addIndexClass(swiperItem, index, 'swiper-counter-compromises');
      const swiperQuick1 = new Swiper(`.swiper-compromises-small-${index}`, {
        direction: 'vertical',
        spaceBetween: 2,
        slidesPerView: 4,
        slideThumbActiveClass: 'b-card__slide-small_active'
      });
      const swiperQuick2 = new Swiper(`.swiper-compromises-${index}`, {
        spaceBetween: 10,
